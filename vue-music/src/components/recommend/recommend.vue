...
import slideSwiper from "base/slider/VueAwesomeSwiper";
import { getRecommend, getDiscList } from "api/recommend";
import { ERR_OK } from "api/config";
import axios from "axios"; // 引入axios 本处特殊因需要配置request headers所以局部注册
import Scroll from "base/scroll/scroll"; // 引入滚动组件
import Loading from "base/loading/loading"; // 引入loading组件
export default {
  name: "recommend",
  data() {
    return {
